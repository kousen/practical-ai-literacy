...
**Time:** 20 minutes
**Data:** `data/messy-meeting-notes.txt` (or your own real notes — better!)

The core skill of this entire course: iterate, don't accept the first draft.

## Setup — pick one path

- **Path A (Copilot):** open [copilot.microsoft.com](https://copilot.microsoft.com) signed in with your Trinity account, or use Copilot Chat in Teams
- **Path B (free tool):** [claude.ai](https://claude.ai), [chatgpt.com](https://chatgpt.com), or [gemini.google.com](https://gemini.google.com) — free accounts are fine
